...
use testing::{express_relay::{helpers::get_express_relay_metadata, set_splits::set_splits_instruction}, helpers::{assert_custom_error, generate_and_fund_key, submit_transaction}, setup::{setup, SetupParams}};
...
fn test_set_splits_fail_wrong_admin() {
    ...
    let split_router_default_new: u64 = 5000;
    let split_relayer_new: u64 = 1000;
    let set_splits_ix = set_splits_instruction(&wrong_admin, split_router_default_new, split_relayer_new);
