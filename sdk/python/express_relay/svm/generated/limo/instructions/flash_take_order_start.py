...
class FlashTakeOrderStartArgs(typing.TypedDict):
    input_amount: int
...
class FlashTakeOrderStartAccounts(typing.TypedDict):
    taker: Pubkey
    maker: Pubkey
