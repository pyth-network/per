use {
    super::{
        get_token_program::GetTokenProgramInput, ChainTypeSvm, Service
    }, crate::{
        api::RestError,
        kernel::entities::ChainId,
    }, ethers::abi::token, solana_sdk::{
        commitment_config::CommitmentConfig,
        program_pack::Pack,
        pubkey::Pubkey,
    }, spl_associated_token_account::get_associated_token_address_with_program_id, spl_token::state::Account, spl_token_2022::{
        extension::StateWithExtensions as TokenAccountWithExtensions,
        state::Account as TokenAccount,
    }
};

pub struct CheckUserBalanceInput {
