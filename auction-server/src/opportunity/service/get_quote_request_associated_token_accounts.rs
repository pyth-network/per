...
use crate::kernel::entities::ChainId;
use crate::{api::RestError, opportunity::entities::FeeToken};
use super::{ChainTypeSvm, Service};
use super::get_express_relay_metadata::GetExpressRelayMetadata;
use spl_token_2022::{
...
impl Service<ChainTypeSvm> {
    pub async fn get_quote_request_associated_token_accounts(
        ...
        let metadata = self.get_express_relay_metadata(GetExpressRelayMetadata {
