...
mod tests {
    ...
    async fn test_get_balance_token_accounts_uninitialized() {
        ...
        let (service, _) = Service::<ChainTypeSvm>::new_with_mocks_svm(
        ...
        let mut auction_service_in_call = StatefulMockAuctionService::<Svm>::default();
        ...
        let auction_service =
            crate::auction::service::MockService::<Svm>::new(auction_service_in_call);
        let config = service
    ...
    async fn test_get_balance_token_accounts_initialized() {
        ...
        let (service, _) =
            Service::<ChainTypeSvm>::new_with_mocks_svm("solana".to_string(), mock_db, &rpc_client);
