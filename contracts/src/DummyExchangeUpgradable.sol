...
import {DummyExchange} from "./DummyExchange.sol";

contract DummyExchangeUpgradable is
    Initializable,
    ...
    DummyExchange
{
    ...
    function initialize(address owner, address permit2) public initializer {
        ...
        DummyExchange._initialize(permit2);
    ...
    function _magicCheck() internal view {
        ...
        // is different.
        if (this.dummyExchangeUpgradableMagic() != 0x7cd21e90)
            revert InvalidMagicValue();
    }

    function dummyExchangeUpgradableMagic() public pure returns (uint32) {
        return 0x7cd21e90;
    }
